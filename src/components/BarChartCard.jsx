...
const options = {
  ...
  scales: {
    x: {
      ...
      ticks: {
        display: true,
        font: { size: 10 }, // Smaller text size
        padding: 5, // Add some space between tick labels and axis
...
const BarChartCard = () => (
  <div className="w-[200px] h-[200px] flex flex-col items-start whitespace-pre-wrap"> {/* Align to left */}
    <h2 className="text-xs font-medium mb-1">HTS_POS ROLLING TARGET</h2>

import ApinLogo from "../assets/apin-logo.png"; // Import the logo
import IconOrderBg from "../assets/iconorderbg.png"; // Import the background image
...
function ApinHeader() {
  return (
    ...
    >
      {/* Image container with the APIN logo */}
      <div 
